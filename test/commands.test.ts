...
describe("echo command", () => {
  it("displays text", async () => {
    ...
    const result = echoCmd.execute({ remainder: "Hello World", agent } as any);
...
describe("var set command", () => {
  ...
  it("shows error on invalid syntax", async () => {
    const { agent } = createMockAgent();
    expect(varSetCmd.execute({ remainder: "invalid", agent } as any)).rejects.toThrow("Invalid syntax");
  });
});
...
describe("vars list command", () => {
  it("lists all variables", async () => {
    ...
    const result = varsListCmd.execute({ agent } as any);
  ...
  it("clears all variables", async () => {
    const { agent, context } = createMockAgent();
    context.setVariable("name", "Alice");
    const _result = varsListCmd.execute({ agent } as any);
...
describe("list command", () => {
  ...
  it("shows error on invalid syntax", async () => {
    const { agent } = createMockAgent();
    expect(listCmd.execute({ remainder: "invalid", agent } as any)).rejects.toThrow("Invalid syntax");
  });
});
...
describe("for command", () => {
  ...
  it("shows error on invalid syntax", async () => {
    const { agent } = createMockAgent();
    expect(forCmd.execute({ remainder: "invalid", agent } as any)).rejects.toThrow("Invalid syntax");
  });

  it("shows error on missing block", async () => {
    const { agent } = createMockAgent();
    expect(forCmd.execute({ remainder: "$item in @list", agent } as any)).rejects.toThrow("Missing");
  });
});
...
describe("if command", () => {
  ...
  it("shows error on invalid syntax", async () => {
    const { agent } = createMockAgent();
    expect(ifCmd.execute({ remainder: "invalid", agent } as any)).rejects.toThrow("Invalid syntax");
  });
});
...
describe("while command", () => {
  it("loops while condition is truthy", async () => {
    ...
    const _result = await whileCmd.execute({ remainder: "$count { /echo loop }", agent } as any);
  ...
  it("shows error on invalid syntax", async () => {
    const { agent } = createMockAgent();
    expect(whileCmd.execute({ remainder: "invalid", agent } as any)).rejects.toThrow("Invalid syntax");
  });
});
